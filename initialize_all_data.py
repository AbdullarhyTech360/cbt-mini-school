...
try:
    ...
    # print("pip install flask flask-sqlalchemy sqlalchemy flask-bcrypt python-docx weasyprint xhtml2pdf xlsxwriter cryptography")
    sys.exit(1)
...
def create_initialization_flag():
    ...
    try:
        ...
        # print(f"Warning: Could not create initialization flag: {e}")
        pass
